...
namespace Sales.API.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckCountriesAsync();//Metodo para crear Paises
        ...
        private async Task<User> CheckUserAsync(string document, string firstName, string lastName, string email, string phone, string address, UserType userType)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.AddUserAsync(user, "123456");//Clave del Usuario
                await _userHelper.AddUserToRoleAsync(user, userType.ToString()); // Rol admin
            }
